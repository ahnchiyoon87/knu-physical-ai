...
const examples={"table": {"feature_ids": [302, 303], "split": "ordered", "train_fraction": 0.7}, "pyod": {"column_id": 22, "lot_id": "4", "baseline_count": 200}, "forecast": {"column_id": 22, "lot_id": "4", "horizon": 20, "evaluate_last": true}}
