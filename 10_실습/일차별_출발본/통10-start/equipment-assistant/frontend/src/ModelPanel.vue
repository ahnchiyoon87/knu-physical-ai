...
const examples={"table": {"feature_ids": [302, 303], "split": "ordered", "train_fraction": 0.7}, "pyod": {"column_id": 22, "lot_id": "4", "baseline_count": 200}, "forecast": {"column_id": 22, "lot_id": "4", "horizon": 20, "evaluate_last": true}, "rul": {"subset": "FD001", "sensor_indices": [6, 7, 8, 10, 11, 12, 13, 14]}, "threshold": {"column_id": 22, "lot_id": "5", "threshold": 10.5, "direction": "above"}, "vision": {"side": "left", "method": "padim", "backbone_path": "artifacts/padim-resnet18.pt", "output_name": "vision-01"}}
