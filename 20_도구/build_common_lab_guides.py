...
from lab_rules_pipeline_guidance import RULES_PIPELINE_ACTION
AFTER_ACTION = {**AFTER_ACTION, **QUALITY_ACTION, **TABLE_ACTION, **RULES_PIPELINE_ACTION}
...
EXTRA = {
 ('rules',0): '참고 구현의 세 규칙은 LOT 조건표 기준 ±1.5 mm, LOT 첫 200행 평균 대비 2.5% 초과 변화, 쿠션 2.5% 초과 상승 AND 계량시간 2.5% 초과 하락입니다. 교육용 기준입니다. 절대 기준은 조건표가 적용되는 모든 행을 비교합니다. 상대·조합 기준은 LOT 첫 200행으로 기준을 만들고 그 뒤의 관측을 판정합니다.',
