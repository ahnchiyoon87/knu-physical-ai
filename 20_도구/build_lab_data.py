...
def main():
    ...
    synthetic["shots"].update({'joins': [{'source_id': 'conditions', 'left_column': 'lot_id', 'right_column': 'lot_id', 'meaning': '해당 LOT의 교육용 설정 기준', 'provenance': '설계: 합성 샷의 LOT별 대응 기록'}, {'source_id': 'worklog', 'left_column': 'lot_id', 'right_column': 'lot_id', 'meaning': '해당 LOT의 교육용 관측 기록', 'provenance': '설계: 합성 샷의 LOT별 대응 기록'}], 'quality_rules': {'22': {'lower': 0, 'provenance': '설계: 교육용 음수 쿠션 검토 표시. 원인 판정이나 자동 삭제 기준이 아님'}}, 'clean_table': 'synthetic_shots_clean', 'duplicate_column_candidates': [[10, 22]]})
